...
$(document).ready(function(){
     ...
     $("input:text").keyup(function(){$(this).next("label").html($(this).val());});
     $("#submit").mouseover(function(){$(this).animate({"background-color":"#0000FF", "width":"140px"},400,"linear");});
     $("#submit").mouseout(function(){$(this).animate({"background-color":"#3377FF","width":"60px"}, 400, "linear");});
     $("#submit").focus(function(){$this().animate({"background-color":"#0000FF","border-width":"5px"}, 400, "linear");});
     $("optgroup").mouseover(function(){$(this).stop(true).animate({"font-size":"18px"}, 200); return false;});
     $("optgroup").mouseout(function(){$(this).stop(true).animate({"font-size":"15px"}, 200); return false;});
});
